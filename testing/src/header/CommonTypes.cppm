// This was generated by my little typescript <=> C++ IDL thing, originally
// I'm using this as a test bed to get modules going.
...
#pragma region string enum Keys
  ...
  inline constexpr string_view to_string(Keys _value) {
    switch (_value) {
      case Keys::Find:
        return "F";
      case Keys::Settings:
  ...
  template <>
  inline constexpr optional<Keys> from_string<Keys>(string_view str) {
    if (str == "F")
      return Keys::Find;
    if (str == ",")
...
#pragma region string enum StrId
  ...
  inline constexpr string_view to_string(StrId _value) {
    switch (_value) {
      case StrId::FilePath:
        return "File Path";
      case StrId::FilesSelected:
  ...
  // A deeply nested switch statement would be pretty fun to generate...
  template <>
  inline constexpr optional<StrId> from_string<StrId>(string_view str) {
    if (str == "File Path")
...
#pragma region linear enum CurrentView
  ...
  inline constexpr string_view to_name(CurrentView _value) {
    switch (_value) {
      case CurrentView::disabled:
        return "disabled";
      case CurrentView::none:
  ...
  inline constexpr string_view to_string(CurrentView _value) {
    switch (_value) {
      case CurrentView::disabled:
        return "-1";
      case CurrentView::none:
  ...
  template <>
  inline constexpr optional<CurrentView> from_string<CurrentView>(
      string_view _str) {
    int _val;
    auto [ptr, ec] = from_chars(_str.data(), _str.data() + _str.size(), _val);
    if (ec != std::errc{}) {
      return std::nullopt;
    }
...
#pragma region linear enum IpcCall
  ...
  inline constexpr string_view to_name(IpcCall _value) {
    switch (_value) {
      case IpcCall::Unknown:
        return "Unknown";
      case IpcCall::ReadFromStorage:
  ...
  inline constexpr string_view to_string(IpcCall _value) {
    switch (_value) {
      case IpcCall::Unknown:
        return "0";
      case IpcCall::ReadFromStorage:
  ...
  template <>
  inline constexpr optional<IpcCall> from_string<IpcCall>(string_view _str) {
    uint8_t _val;
    auto [ptr, ec] = from_chars(_str.data(), _str.data() + _str.size(), _val);
    if (ec != std::errc{}) {
      return std::nullopt;
...
#pragma region numeric enum SocketMsg
  enum class SocketMsg : uint8_t { Unknown, ContentLoaded, KeepAlive };
  ...
  inline constexpr string_view to_name(SocketMsg _value) {
    switch (_value) {
      case SocketMsg::Unknown:
        return "Unknown";
      case SocketMsg::ContentLoaded:
  ...
  inline constexpr string_view to_string(SocketMsg _value) {
    switch (_value) {
      case SocketMsg::Unknown:
        return "0";
      case SocketMsg::ContentLoaded:
  ...
  template <>
  inline constexpr optional<SocketMsg> from_string<SocketMsg>(
      string_view _str) {
    uint8_t _val;
    auto [ptr, ec] = from_chars(_str.data(), _str.data() + _str.size(), _val);
    if (ec != std::errc{}) {
...
#pragma region string enum StorageId
  ...
  inline constexpr string_view to_string(StorageId _value) {
    switch (_value) {
      case StorageId::CurrentView:
        return "currentView";
      case StorageId::SettingValue:
  ...
  // A deeply nested switch statement would be pretty fun to generate...
  template <>
  inline constexpr optional<StorageId> from_string<StorageId>(string_view str) {
    if (str == "currentView")
...
#pragma region JSON serialization for string enum Keys
  ...
  struct impl_from_json<Shared::Keys> {
    static inline optional<Shared::Keys> process(
...
#pragma region JSON serialization for string enum StrId
  ...
  struct impl_from_json<Shared::StrId> {
    static inline optional<Shared::StrId> process(
        const crow::json::rvalue& _value) {
      if (_value.t() != crow::json::type::String)
        return std::nullopt;
      auto _str = _value.s();
...
#pragma region JSON serialization for string enum StorageId
  ...
  struct impl_from_json<Shared::StorageId> {
    static inline optional<Shared::StorageId> process(
        const crow::json::rvalue& _value) {
      if (_value.t() != crow::json::type::String)
        return std::nullopt;
      auto _str = _value.s();
...
#pragma region JSON serialization for object MimeData
  ...
  template <>
  inline optional<Shared::MimeData> from_json<Shared::MimeData>(
      const crow::json::rvalue& _value) {
...
#pragma region JSON serialization for object FileFilterItem
  ...
  template <>
  inline optional<Shared::FileFilterItem> from_json<Shared::FileFilterItem>(
      const crow::json::rvalue& _value) {
    if (_value.t() != crow::json::type::Object)
      return std::nullopt;
...
#pragma region JSON serialization for object OpenDialogOptions
  ...
  template <>
  inline optional<Shared::OpenDialogOptions>
...
#pragma region JSON serialization for object FileSystemItem
  ...
  template <>
  inline optional<Shared::FileSystemItem> from_json<Shared::FileSystemItem>(
      const crow::json::rvalue& _value) {
    if (_value.t() != crow::json::type::Object)
      return std::nullopt;
    ...
    if (!_value.has("size"))
      return std::nullopt;
    auto _size_opt_ = from_json<uint64_t>(_value["size"]);
